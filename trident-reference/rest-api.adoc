...
[.lead]
While link:trident-cl.html[tridentctl commands and options] are the easiest way to interact with the Trident REST API, you can use the REST endpoint directly if you prefer.
