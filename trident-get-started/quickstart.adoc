...
[.lead]
You can install Trident and start managing storage resources in a few steps. Before getting started, review link:../trident-get-started/requirements.html[Trident requirements].
