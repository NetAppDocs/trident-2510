...
NOTE: You can also use alternative ways to detect node failure as specified in the link:force-detach.html#integrating-custom-node-health-check-solutions[Integrating Custom Node Health Check Solutions] section below.
